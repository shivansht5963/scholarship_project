    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caste_category', models.CharField(choices=[('GEN', 'General'), ('OBC', 'OBC'), ('SC', 'SC'), ('ST', 'ST')], default='GEN', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_exam_score', models.FloatField(blank=True, help_text='Percentage or CGPA', null=True)),
